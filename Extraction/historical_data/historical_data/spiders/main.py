...
class stockPrices(scrapy.Spider):
    ...
    start_urls = ['https://finance.yahoo.com/quote/%5EGSPC/history?period1=1653004800&period2=1661990400&interval=1d&filter=history&frequency=1d&includeAdjustedClose=true'] #url_list

    def parse(self, response):
         
        with open('Output_3.csv', 'a', newline='') as csvfile:
